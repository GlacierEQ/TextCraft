    ...
    public partial class MainForm : Form
    {
        ...
        private void UpdateUIForCurrentLanguage()
        {
            try
            {
                UpdateFormTitle();
                // Update menu items
                MainMenuStrip.Items[0].Text = LocalizationHelper.GetString("Menu_Language");
                ((ToolStripMenuItem)MainMenuStrip.Items[0]).DropDownItems[0].Text = 
                    LocalizationHelper.GetString("Menu_SelectLanguage");
